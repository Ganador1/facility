...
- `outcomes` (org_id, project_id, repo, pr_number, agent_lane, opened_at, terminal_at, fate merged|closed, review_rounds int, fixup_commits int, hours_to_terminal numeric; unique(org_id, repo, pr_number))

...
// must stay byte-identical to the templates, or adopters get a different
// runner than the one we test on ourselves.
test("dogfooded guards match the shipped templates", () => {
  for (const file of ["run.mjs", "_kit.mjs", "actions-pinned.mjs"]) {
    ...
    const ours = readFileSync(join(pkgRoot, "guards", file), "utf8");
